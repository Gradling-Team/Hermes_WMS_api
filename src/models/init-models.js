...
function initModels(sequelize) {
  ...
  ENTITY.belongsToMany(RECEPTION, { as: 'ID_recept_RECEPTIONs', through: RECEIVE, foreignKey: "ID_Ep", otherKey: "ID_recept" });
  Groupe.belongsToMany(WAREHOUSE, { as: 'ID_WAREHOUSE_WAREHOUSEs', through: PARTOF, foreignKey: "ID", otherKey: "ID_WAREHOUSE" });
  RECEPTION.belongsToMany(ENTITY, { as: 'ID_Ep_ENTITies', through: RECEIVE, foreignKey: "ID_recept", otherKey: "ID_Ep" });
  WAREHOUSE.belongsToMany(Groupe, { as: 'ID_Groupes', through: PARTOF, foreignKey: "ID_WAREHOUSE", otherKey: "ID" });
  ...
  ENTITY.belongsTo(ORDER_TICKET, { as: "ID_ORDER_ORDER_TICKET", foreignKey: "ID_ORDER"});
  ORDER_TICKET.hasMany(ENTITY, { as: "ENTITies", foreignKey: "ID_ORDER"});
  ENTITY.belongsTo(PRODUCT_FORM, { as: "ID_prod_PRODUCT_FORM", foreignKey: "ID_prod"});
  PRODUCT_FORM.hasMany(ENTITY, { as: "ENTITies", foreignKey: "ID_prod"});
  RECEIVE.belongsTo(RECEPTION, { as: "ID_recept_RECEPTION", foreignKey: "ID_recept"});
  RECEPTION.hasMany(RECEIVE, { as: "RECEIVEs", foreignKey: "ID_recept"});
  ENTITY.belongsTo(STORAGE_AREA, { as: "ID_AREA_STORAGE_AREA", foreignKey: "ID_AREA"});
  ...
  PARTOF.belongsTo(WAREHOUSE, { as: "ID_WAREHOUSE_WAREHOUSE", foreignKey: "ID_WAREHOUSE"});
  WAREHOUSE.hasMany(PARTOF, { as: "PARTOFs", foreignKey: "ID_WAREHOUSE"});
  STORAGE_AREA.belongsTo(WAREHOUSE, { as: "ID_WAREHOUSE_WAREHOUSE", foreignKey: "ID_WAREHOUSE"});
  WAREHOUSE.hasMany(STORAGE_AREA, { as: "STORAGE_AREAs", foreignKey: "ID_WAREHOUSE"});
